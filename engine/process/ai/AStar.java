...
/**
 * AStar is an ai which generate the fastest path between 2 nodes.
 */
public class AStar {
    ...
    public AStar(Node initialNode, Node finalNode, int hvCost, int diagonalCost) {
        int rows= GameConfiguration.WINDOW_WIDTH+1;
        int cols= GameConfiguration.WINDOW_HEIGHT+1;
        this.hvCost = hvCost;
    ...
    public void setBlocks() {
        WallsAndComponentsLocalisation w=new WallsAndComponentsLocalisation();
        int[][] blocksArray= w.blocksArray();
